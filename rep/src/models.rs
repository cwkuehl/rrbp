...
impl Clone for AgDialog {
    fn clone(&self) -> Self {
        Self {
            ...
            nr: self.nr,
            url: self.url.clone(),
            frage: self.frage.clone(),
            antwort: self.antwort.clone(),
            angelegt_von: self.angelegt_von.clone(),
            angelegt_am: self.angelegt_am.clone(),
            geaendert_von: self.geaendert_von.clone(),
            geaendert_am: self.geaendert_am.clone(),
...
impl PartialEq for AgDialog {
    fn eq(&self, other: &Self) -> bool {
        self.mandant_nr == other.mandant_nr
            ...
            && self.nr == other.nr
            && self.url == other.url
            && self.frage == other.frage
            && self.antwort == other.antwort
    }
}

impl Revision for AgDialog {
    fn get_angelegt_von(&self) -> Option<String> {
        self.angelegt_von.clone()
    }
    fn set_angelegt_von(&mut self, von: &Option<String>) {
...
impl PartialEq for TbWetter {
    fn eq(&self, other: &Self) -> bool {
        self.mandant_nr == other.mandant_nr
            && self.datum == other.datum
            && self.ort_uid == other.ort_uid
            && self.api == other.api
            && self.werte == other.werte
    }
}

impl Revision for TbWetter {
    fn get_angelegt_von(&self) -> Option<String> {
        self.angelegt_von.clone()
    }
    fn set_angelegt_von(&mut self, von: &Option<String>) {
